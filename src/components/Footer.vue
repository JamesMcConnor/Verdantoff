...
<template>
    <div class="pt-0">
        ...
        <footer v-if="!$route.meta.showNav" id="footerId" class="bg-black relative z-0 dark:bg-gray-900">
...
<style scoped>@import url("https://cdn.tuk.dev/dist/css/tailwind-v2.2.11.min.css");</style>
